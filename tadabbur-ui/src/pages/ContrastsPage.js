...
import { Search, Scale, BookOpen, Zap, ArrowRightLeft } from "lucide-react";
  ...
  const filteredData = useMemo(() => {
    return contrastsData.filter((item) => {
      ...
      const matchesSearch = 
        ...
        item.ayahs.some(a => a.ayah_text.toLowerCase().includes(searchLower) || a.surah_name.includes(searchTerm));
  ...
  return (
    <div className="space-y-12 pb-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade">
      ...
      <DataFilterHeader 
        ...
        placeholder="ابحث في الثنائيات والتقابلات..."
        isRtl={isRtl}
      />
